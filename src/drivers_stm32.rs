...
pub type MotorDriverQuadPwm =
    MotorDriverQuadPwmGeneral<embassy_stm32::peripherals::TIM4, embassy_stm32::peripherals::TIM3>;
    ...
    T2: GeneralInstance4Channel,
{
    pub fn new(pwm1: SimplePwm<'static, T1>, pwm2: SimplePwm<'static, T2>) -> Self {
        ...
        Self { ch0: channels1.ch1, ch1: channels1.ch2, ch2: channels2.ch3, ch3: channels2.ch4 }
    }
