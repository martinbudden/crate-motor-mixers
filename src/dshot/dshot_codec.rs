...
impl DshotEncoder {
    ...
    #[inline]
    #[must_use]
    pub fn pwm_to_dshot(pwm: u16) -> u16 {
    ...
    #[inline]
    #[must_use]
    pub fn pwm_to_dshot_clamped(pwm: u16) -> u16 {
        if pwm >= 2000 {
            Self::THROTTLE_MAX
        } else if pwm >= 1000 {
            Self::pwm_to_dshot(pwm)
        } else {
            Self::THROTTLE_MIN
        }
    }
    ...
    pub fn encode_pwm_unidirectional(pwm: u16) -> u16 {
        Self::encode_raw_unidirectional(Self::pwm_to_dshot_clamped(pwm))
    }

    #[inline]
    #[must_use]
    pub fn encode_pwm_bidirectional(pwm: u16) -> u16 {
        Self::encode_raw_bidirectional(Self::pwm_to_dshot_clamped(pwm))
    }
...
mod tests {
    ...
    #[test]
    fn dshot_codec() {
        assert_eq!(48, DshotEncoder::pwm_to_dshot(1000));
        assert_eq!(2048, DshotEncoder::pwm_to_dshot(2000));

        assert_eq!(48, DshotEncoder::pwm_to_dshot_clamped(0));
        assert_eq!(48, DshotEncoder::pwm_to_dshot_clamped(10));
        assert_eq!(48, DshotEncoder::pwm_to_dshot_clamped(999));

        assert_eq!(48, DshotEncoder::pwm_to_dshot_clamped(1000)); // should this be 0 or 48 ?
        //assert_eq!(48, DshotCodec::pwm_to_dshot_clamped(1000)); // should this be 0 or 48 ?
        assert_eq!(50, DshotEncoder::pwm_to_dshot_clamped(1001));
        assert_eq!(52, DshotEncoder::pwm_to_dshot_clamped(1002));
        assert_eq!(54, DshotEncoder::pwm_to_dshot_clamped(1003));
        assert_eq!(1048, DshotEncoder::pwm_to_dshot_clamped(1500));
        assert_eq!(2046, DshotEncoder::pwm_to_dshot_clamped(1999));
        assert_eq!(2047, DshotEncoder::pwm_to_dshot_clamped(2000));
        assert_eq!(2047, DshotEncoder::pwm_to_dshot_clamped(2001));
        assert_eq!(2047, DshotEncoder::pwm_to_dshot_clamped(2002));
        assert_eq!(2047, DshotEncoder::pwm_to_dshot_clamped(4000));
